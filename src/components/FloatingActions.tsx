...
// Compact circle by default; expands leftward to reveal the label on hover.
const shell =
  "group flex h-12 items-center justify-end overflow-hidden rounded-full border border-bone/15 bg-ink text-bone shadow-[0_6px_20px_rgba(14,14,13,0.25)] transition-colors duration-300 hover:bg-accent";
const label =
  "max-w-0 overflow-hidden whitespace-nowrap pl-0 text-sm font-medium leading-none tracking-tight transition-[max-width,padding] duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:max-w-[7rem] group-hover:pl-4";
const dot = "grid h-12 w-12 shrink-0 place-items-center";
...
export default function FloatingActions() {
  ...
  return (
    <div
      className="fixed bottom-5 right-5 z-[70] flex flex-col items-end gap-3 sm:bottom-6 sm:right-6"
